...
class CategoryController extends Controller
{
    ...
    public function add() {
		$categories = Categories::where([ ['status', 1], ['is_deleted', 0] ])->get();
    ...
    public function store(Request $request) {
        ...
        if(Categories::where('name', $request->input('name'))->first() !=null ){
            return response()->json([
                'code' => 403,
    ...
    public function update(Request $request, $id) {
    	...
    	if($validate->fails()){
            ...
            if(Categories::where([ ['name', $request->input('name') ], ['id', '<>', $id] ])->first() !=null ){
                return response()->json([
                    'code' => 403,
                    'msg' => 'name không được trùng!'
                ]);
            ...
            CategoryObj::where('category_id', $id)->update([
