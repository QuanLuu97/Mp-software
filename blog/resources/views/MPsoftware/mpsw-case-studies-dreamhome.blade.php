...
<div class="mpsw-about-title bg-case-studies">
  <div class="container">
    <div class="content-page-title">
      <p class="sub-title"><a href="#">Home</a> /<a href="#">Case studies</a>  /<a href="#">Dream home</a> </p>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="box-img-dream">
                    <img src="dist/images/dream-home.png">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <div class="requirement">
                    <h4>Requirement</h4>
                    <p>Proving a free application as an information exchanging channel between lessors and renters.<br>Advertisement on application</p>
                  </div>
