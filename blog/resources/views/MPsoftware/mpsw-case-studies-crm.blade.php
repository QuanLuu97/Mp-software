...
<div class="mpsw-about-title bg-case-studies">
  <div class="container">
    <div class="content-page-title">
      <p class="sub-title"><a href="{{ route('index') }}">Home</a> /<a href="#">Case studies</a>  /<a href="#">{{ $case_studies1->name }}</a> </p>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6">
            <div class="box-img-crm">
              <img src="/uploads/images/{{ json_decode($case_studies1->images)[0] }}">
            </div>
          </div>
        </div>
      </div>
