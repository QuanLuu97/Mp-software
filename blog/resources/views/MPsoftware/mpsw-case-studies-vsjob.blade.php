...
<div class="mpsw-about-title bg-case-studies">
  <div class="container">
    <div class="content-page-title">
      <p class="sub-title"><a href="#">Home</a> / <a href="#">Case studies</a> / <a href="#">SV jobs</a></p>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="requirement">
                  <h4>Requirement</h4>
                  <p>Providing a free application allowing students of searching for jobs that suit their required time and avenue. <br>Advertisement on App.</p>
                </div>
                <div class="service-skill">
                  <h4>Technology</h4>
                  <p>Server: PHP, My SQL<br>App: Swift, Android</p>
                </div>
              </div>
              <div class="col-md-6 col-sm-6">
                <div class="box-img-svjob">
                  <img src="dist/images/svjob.png">
                </div>
              </div>
            </div>
          </div>
