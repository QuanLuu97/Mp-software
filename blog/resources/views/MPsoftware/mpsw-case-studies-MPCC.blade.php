    ...
    <nav class="navbar navbar-default mpsw-nav">
      ...
      <div id="navbarCollapse" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
        <ul class="nav navbar-nav navbar-right navbar-main">
          <li><a href="http://mpsoftware.com.vn"> HOME</a></li>
          <li class="has-child active"><a href="#">ABOUT US<span><i class="fa fa-angle-down" aria-hidden="true"></i></span></a>
            <ul class="sub-menu">
          ...
          <li class="has-child"><a href="#">SERVICES<span><i class="fa fa-angle-down" aria-hidden="true"></i></span></a>
            <ul class="sub-menu">
              <li><a href="#">Our company</a></li>
              <li><a href="#"> Our people </a></li>
              <li><a href="#"> Our business process</a></li>
          ...
          <li class="has-child"><a href="#">CASE STUDIES<span><i class="fa fa-angle-down" aria-hidden="true"></i></span></a>
            <ul class="sub-menu">
              <li><a href="#">Our company</a></li>
              <li><a href="#"> Our people </a></li>
              <li><a href="#"> Our business process</a></li>
...
<div class="mpsw-about-title bg-case-studies">
  <div class="container">
    <div class="content-page-title">
      <p class="sub-title"><a href="#">Home</a> / <a href="#">Case studies</a> / <a href="#">MPCC</a></p>
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="requirement">
                  ...
                  <p>Optimize costs, make use of existing infrastructure, however, ensure that businesses interact with customers via voice channels, SMS, Email and Chat.</p>
                </div>
                <div class="service-skill">
                  <h4>Our Solutions &amp; Services</h4>
                  <p>Upgrading MPCC (Cloud Call Center)integrated with Contact Center The system performs these main functions:</p>
                  <ul class="list-requirement">
                    <li>Calls receiving, distributing, and monitoring</li>
                    <li>SMS</li>
                    <li>Chat</li>
                    <li>Users, group-users managing and decentralizing.</li>
                    <li>Reports and Statistics recording.</li>
                  </ul>
                  <p>Technology : HTML, CSS, AngularJS, Java, Socket IO, My SQL</p>
                </div>
              </div>
              <div class="col-md-6 col-sm-6">
                <div class="box-img-mpcc">
                  <img src="dist/images/mpcc.png" width="90%">
                  <p class="txt-center">Connect customers anytime, anywhere</p>
                </div>
              </div>
            </div>
          </div>
