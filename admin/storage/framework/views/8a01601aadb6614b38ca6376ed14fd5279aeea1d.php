...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo e(route('indexCat')); ?>">Menu</a>
...
<div class="col-md-8 col-md-offset-2">
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form"> 
            <form action="<?php echo e(route('updateMenu', $menu->id)); ?>" enctype="multipart/form-data" method="post" id="form-edit">
                <div class="form-group">
                    <label for="name">name</label>
                    <input type="text" id="name" name="name" class="form-control" value="<?php echo e($menu->name); ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" ><?php echo e($menu->description); ?></textarea>
                </div>
                <div class="form-group">
                    <label>content</label> 
                    <textarea name="content"  id="content" ><?php echo e($menu->content); ?></textarea>
                </div>
                <div class="form-group">
                    <label>content2</label> 
                    <textarea name="content2"  id="content2" ><?php echo e($menu->content2); ?></textarea>
                </div>
                 <div class="form-group">
                    <label>sort</label> 
                    <input type="number" name="sort" id="sort" class="form-control" value="<?php echo e($menu->sort); ?>">
                </div>
                <div class="form-group">
                    <label>images</label> 
                ...
                <input type="hidden" id="id" value="<?php echo e($menu->id); ?>">
                <input type="submit" name="btn_update" class="btn btn-success" value="update">
                <a href="<?php echo e(route('indexMenu')); ?>" class="btn btn-default">Cancel</a>
